...
export type RouterDecisionReason = 'mention' | 'reply-context' | 'default-agent' | 'best-match' | 'fallback';
...
export type ChatToolInvocationState = 'input-streaming' | 'input-available' | 'output-available' | 'error' | 'approval-requested' | 'approval-responded';
...
export type ChatMessagePart = ChatTextMessagePart | ChatImageMessagePart | ChatFileMessagePart;
