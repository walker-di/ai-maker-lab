 ...
 */
export type HostedToolEventKind = 'tool-call-started' | 'tool-call-output' | 'tool-call-finished' | 'tool-call-failed';
...
export type HostedToolEvent = HostedToolStartedEvent | HostedToolOutputEvent | HostedToolFinishedEvent | HostedToolFailedEvent;
export declare function isHostedToolEvent(value: unknown): value is HostedToolEvent;
